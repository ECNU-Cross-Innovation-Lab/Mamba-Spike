...
from data.dataset_loader import prepare_cifar10dvs_dataset
...
class CIFAR10DVSTrainer:
    def __init__(self, batch_size=8, lr=0.001, max_epochs=200):
        ...
        print("⚠ Note: First load may take time (dataset is ~4GB)")
        self.train_loader, self.test_loader, self.num_classes = prepare_cifar10dvs_dataset(
            batch_size=batch_size,
            num_workers=0,  # CRITICAL: Avoid DataLoader deadlock on Windows
            time_window=1000000,
            dt=10000
        )
